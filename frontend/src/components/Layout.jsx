  ...
  const StatCard = ({ title, value, icon }) => (
    <div className="p-2 sm:p-3 rounded-xl bg-white shadow-sm border border-blue-100 hover:shadow-md transition-all duration-300 hover:border-blue-200 group">
      <div className="flex items-center gap-2">
        <div className="p-1.5 rounded-lg bg-gradient-to-br from-blue-400/10 to-blue-600/10 group-hover:from-blue-400/20 group-hover:to-blue-600/20">
          {icon}
        </div>
        <div className="min-w-0">
          <p className="text-lg sm:text-xl font-bold bg-gradient-to-r from-blue-400 to-blue-800 bg-clip-text text-transparent">
            {value}
          </p>
            ...
            <div className="bg-white rounded-xl p-4 sm:p-5 shadow-sm border border-blue-100">
              ...
              <div className="grid grid-cols-2 gap-3 sm:gap-4 mb-4 sm:mb-6">
                <StatCard 
                  ...
                  icon={<Circle className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-blue-600" />} 
                />
                <StatCard 
                  title="Completed" 
                ...
                <StatCard
                  ...
                  icon={<Zap className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-blue-600" />}
                />
              </div>
              ...
              <div className="space-y-2 sm:space-y-3">
                <div className="flex items-center justify-between text-gray-700">
                  <span className="text-xs sm:text-sm font-medium flex items-center gap-1.5">
                    <Circle className="w-2.5 h-2.5 sm:w-3 sm:h-3 text-blue-600 fill-blue-600" />
                    Task Progress
                  </span>
                ...
                <div className="relative pt-1">
                  <div className="flex gap-1.5 items-center">
                    <div className="flex-1 h-2 sm:h-3 bg-blue-100 rounded-full overflow-hidden">
                      <div
                        className="h-full bg-gradient-to-r from-blue-400 to-blue-800 transition-all duration-500"
