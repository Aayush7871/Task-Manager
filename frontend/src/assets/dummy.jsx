...
export const baseControlClasses =
    "w-full px-4 py-2.5 border border-blue-100 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-blue-600 text-sm";

export const priorityStyles = {
    Low: "bg-green-100 text-green-700 border-green-200",
    Medium: "bg-blue-100 text-blue-700 border-blue-200",
    High: "bg-sky-100 text-sky-700 border-sky-400",
};
...
export const INPUTWRAPPER =
    "flex items-center border border-blue-100 rounded-lg px-3 py-2.5 focus-within:ring-2 focus-within:ring-blue-600 focus-within:border-blue-600 transition-all duration-200"
export const BUTTON_CLASSES =
    "w-full bg-gradient-to-r from-blue-400 to-blue-800 text-white text-sm font-semibold py-2.5 rounded-lg hover:shadow-md transition-all duration-200 flex items-center justify-center gap-2"

// PROFILE CSS
export const INPUT_WRAPPER =
    "flex items-center border border-blue-100 rounded-lg px-3 py-2.5 focus-within:ring-2 focus-within:ring-blue-600 focus-within:border-blue-600 transition-all duration-200"
export const FULL_BUTTON =
    "w-full bg-gradient-to-r from-blue-400 to-blue-800 text-white py-2.5 rounded-lg hover:shadow-md transition-all duration-200 flex items-center justify-center gap-2"
...
export const LINK_CLASSES = {
    ...
    active: "bg-gradient-to-r from-blue-50 to-sky-50 border-l-4 border-blue-500 text-blue-700 font-medium shadow-sm",
    inactive: "hover:bg-blue-50/50 text-gray-600 hover:text-blue-700",
    icon: "transition-transform duration-300 group-hover:scale-110 text-blue-600",
...
export const PRODUCTIVITY_CARD = {
    ...
    barFg: "h-full bg-gradient-to-r from-blue-400 to-blue-800 animate-pulse",
}

export const TIP_CARD = {
    container: "bg-gradient-to-r from-blue-50 to-sky-50 rounded-xl p-4 border border-blue-100",
...
export const ADD_BUTTON =
    "flex items-center gap-2 bg-gradient-to-r from-blue-400 to-blue-800 text-white px-4 py-2 rounded-lg shadow-sm hover:shadow-md transition-all duration-200 w-full md:w-auto justify-center text-sm md:text-base"
...
export const ICON_WRAPPER = "p-1.5 md:p-2 rounded-lg bg-blue-100 text-blue-700"
...
export const STATS = [
    ...
    { key: "mediumPriority", label: "Medium Priority", icon: Flame, iconColor: "bg-sky-100 text-sky-600", borderColor: "border-sky-100", valueKey: "mediumPriority", textColor: "text-sky-600" },
...
export const EMPTY_STATE = {
    ...
    btn: "px-4 py-2 bg-gradient-to-r from-blue-400 to-blue-800 text-white rounded-lg text-sm font-medium",
}

// Filter UI Constants
export const FILTER_WRAPPER = "flex items-center justify-between bg-white p-4 rounded-xl shadow-sm"
export const SELECT_CLASSES = "px-3 py-2 border border-blue-100 rounded-lg focus:ring-2 focus:ring-blue-600 md:hidden text-sm"
...
export const TAB_ACTIVE = "bg-white text-blue-700 shadow-sm border border-blue-100"
export const TAB_INACTIVE = "text-gray-600 hover:text-blue-100/50"
...
export const CT_CLASSES = {
    ...
    select: "px-2 py-1 md:px-3 md:py-2 border border-blue-100 rounded-lg focus:ring-2 focus:ring-blue-600 md:hidden text-xs md:text-sm",
...
export const layoutClasses = {
    ...
    select: "px-3 py-2 border border-blue-100 rounded-lg focus:ring-2 focus:ring-blue-600 md:hidden text-sm",
...
export const TI_CLASSES = {
    ...
    progressBarFg: "h-full bg-gradient-to-r from-blue-400 to-blue-800 transition-all duration-300",
