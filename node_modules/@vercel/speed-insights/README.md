...
![Vercel Speed Insights](https://github.com/vercel/speed-insights/blob/main/.github/banner.png)

<p align="center"><strong>Performance insights for your website</strong></p>
...
> ⚠️ This package does **not** track data in development mode.
...
> It also supports other frameworks, vanilla JavaScript, and static websites.
...
1. **Enable Speed Insights**
   ...
   * Go to the [Vercel Dashboard](https://vercel.com/d?to=%2F%5Bteam%5D%2F%5Bproject%5D%2Fspeed-insights&title=Open+Web+Analytics) and enable Speed Insights for your project.
...
3. **Inject Speed Insights into your app**

   * **Next.js / React / Nuxt / Vue:** Use the `<SpeedInsights />` component.
   * **SvelteKit:** Use the `injectSpeedInsights()` function in your top-level `+layout.js` or `+layout.ts`.
   * **Other frameworks:** Use the `inject` function to add the tracking script.
   * **Static sites:** Follow the [static site setup guide](https://vercel.com/docs/speed-insights/quickstart).

4. **Deploy to Vercel**

   * Once deployed, you’ll start seeing performance data in your dashboard.

---

## 📘 Documentation

For full setup details and API references, visit the [Vercel Speed Insights Documentation](https://vercel.com/docs/speed-insights/quickstart).
